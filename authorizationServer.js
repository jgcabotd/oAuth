...
const Token = mongoose.model('Token', { access_token: String , 
	...
	if (req.body.grant_type == 'authorization_code') {
		...
		if (code) {
			...
			if (code.request.client_id == clientId) {
				...
				token.save().then(_ => console.log("token saved!"));
		...
		var query =  token.find({refresh_token : req.body.refresh_token});
